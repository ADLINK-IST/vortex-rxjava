...
public final class OnSubscribeFromReader<TOPIC> implements Observable.OnSubscribe<TOPIC> {
    ...
    private OnSubscribeFromReader(DataReader<TOPIC> dataReader) {
        if (dataReader == null) {
    ...
    public static <TOPIC> OnSubscribeFromReader<TOPIC> create(DataReader<TOPIC> dataReader) {
        return new OnSubscribeFromReader<TOPIC>(dataReader);
    }
